		...
		enum omap_channel channel)
{
	...
	/* Workaround lost channel changes between a dispc context save and
	 * restore by also updating the OVL_ATTRIBUTES value in the context.
	 */
	dispc.ctx[DISPC_OVL_ATTRIBUTES(plane) / sizeof(u32)] = val;
end:
	dispc_runtime_put();
}
